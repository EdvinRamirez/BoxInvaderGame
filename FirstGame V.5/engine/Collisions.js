  ...
  static inCollision(one, two) {
    if (one instanceof Point) {
      ...
      if (two instanceof Circle) {
        ...
        let circleMin = -two.ballRadius;
        let circleMax = two.ballRadius;
      ...
      //Circle/Circle
      if (two instanceof Circle) {
        let combinedRadius = one.ballRadius + two.ballRadius;
